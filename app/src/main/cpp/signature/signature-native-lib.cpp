...
//真实 APK 的签名
//#define APK_SIGN_MD5 "50:11:2E:F9:95:44:10:34:7D:27:02:5B:41:53:C6:F9"
#define APK_SIGN_MD5 "50:11:2E:F9:95:44:10:34:7D:27:02:5B:41:53:C6:F8"
...
Java_com_test_ndk_study_cpp_signature_NativeSignatureUtil_checkSignature(JNIEnv *env, jobject thiz,
    ...
    if(cmpResult == 0) {
        ...
        strcat(resultStr, "异常（×）");
        //签名不对 强制退出游戏（exit(0)  无法强退游戏，只是退出当前activity）
       // exit(0);
    }
    return env->NewStringUTF(resultStr);
}
